<?php
    ...
    /*$query="CREATE TABLE EMP_TABLE(EMPID INT ,NAME VARCHAR(15), MANAGERID INT, DATEOFJOINING DATE, CITY VARCHAR(15), PROJECT VARCHAR(5), SALARY INT)";
    ...
    $query="INSERT INTO EMP_TABLE VALUES($EMPID,$NAME, $MANAGERID, $DATEOFJOINING, $CITY, $PROJECT, $SALARY)";
